...
// TS tip: ensure tsconfig has  "types": ["google.maps"] and dev-dep @types/google.maps installed.
...
function CurrentPlaceFinder({
  ...
  const markerRef = useRef<google.maps.Marker | null>(null); // classic Marker for setMap(null) support
  ...
  return (
    <div className={"w-full " + (className ?? "")}>
      ...
      {selectedPlace && (
        <div className="mt-3 text-sm p-3 rounded-xl border">
...
export default CurrentPlaceFinder;
