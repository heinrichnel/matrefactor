...
const SystemCostsModal: React.FC<SystemCostsModalProps> = ({
  ...
  // Per-kilometer costs
  const perKmCosts = [
    { type: 'Repair & Maintenance per KM', rate: 2.50, distance, total: 2.50 * distance },
    { type: 'Tyre Cost per KM', rate: 1.80, distance, total: 1.80 * distance }
  ];

  // Per-day fixed costs
  const perDayCosts = [
    { type: 'GIT Insurance', ratePerDay: 80.00, days: tripDuration, total: 80.00 * tripDuration },
    { type: 'Short-Term Insurance', ratePerDay: 60.00, days: tripDuration, total: 60.00 * tripDuration },
    { type: 'Tracking Cost', ratePerDay: 40.00, days: tripDuration, total: 40.00 * tripDuration },
    { type: 'Fleet Management System', ratePerDay: 20.00, days: tripDuration, total: 20.00 * tripDuration },
    { type: 'Licensing', ratePerDay: 15.00, days: tripDuration, total: 15.00 * tripDuration },
    { type: 'VID / Roadworthy', ratePerDay: 10.00, days: tripDuration, total: 10.00 * tripDuration },
    { type: 'Wages', ratePerDay: 300.00, days: tripDuration, total: 300.00 * tripDuration },
    { type: 'Depreciation', ratePerDay: 150.00, days: tripDuration, total: 150.00 * tripDuration }
  ];
      ...
      <div className="p-6 space-y-6">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <p className="text-sm text-blue-700">
                System will automatically apply predefined per-kilometer and per-day fixed cost factors to 
                ensure true operational profitability assessment.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-green-50 border border-green-100 rounded-md p-4">
          ...
          <div className="space-y-1 text-sm text-green-700">
            ...
            <p className="text-xs italic mt-2">* These rates are applicable to this trip based on the trip start date ({tripData.startDate.split('T')[0]})</p>
          </div>
        </div>
        ...
        <div className="bg-green-50 border border-green-100 rounded-md p-4 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-green-700">10 cost entries will be automatically generated</p>
          </div>
          <div className="text-right">
            <div className="text-2xl font-bold text-green-800">{formatCurrency(totalSystemCosts)}</div>
