...
import DemandPartsForm from '../../components/Workshop Management/DemandPartsForm';
    ...
    <div className="container mx-auto px-4 py-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-600 mb-6">
          Use this form to request parts for vehicle maintenance and repairs. 
          Specify the parts needed, quantities, and priority level.
        </p>
