  ...
  useEffect(() => {
    ...
    if (existingReport) {
      ...
      setFormData({
        ...
        immediateActions: existingReport.immediateActions || existingReport.preventativeActionsImmediate,
        preventativeMeasures: existingReport.preventativeMeasures || existingReport.preventativeActionsLongTerm,
        ...
        status: existingReport.status === 'open' || existingReport.status === 'inProgress' ||
               existingReport.status === 'cancelled' ? 'in_progress' : existingReport.status
      });
