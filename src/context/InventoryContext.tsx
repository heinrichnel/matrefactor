...
import { collection, query, where, orderBy, onSnapshot, doc, setDoc, addDoc, updateDoc, deleteDoc, Timestamp, getDocs, increment, serverTimestamp } from 'firebase/firestore';
import { firestore } from '../firebase';
import { Vendor, InventoryItem, PurchaseOrder, StockMovement } from '../types/inventory';
