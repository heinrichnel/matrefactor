...
import { Clipboard, FileText, User, Building2, Truck, Fuel, Box } from 'lucide-react';
...
const ConsolidatedDashboard: React.FC = () => {
  ...
  const getStatusBadge = (status?: string) => {
    ...
    return (
      <span className={`text-xs px-2 py-1 rounded ${badgeClasses[status as keyof typeof badgeClasses]}`}>
    ...
    <div className="container mx-auto p-4">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="mt-2 text-sm">
              ...
              <span className="text-red-600">{mockStats.drivers.expiredLicenses} expired licenses</span>
            </div>
            <Link to="/drivers" className="text-blue-600 hover:underline text-xs block mt-1">View Drivers →</Link>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="mt-2 text-sm">
              ...
              <span className="mx-1">•</span>
              <span className="text-yellow-600">{mockStats.vehicles.maintenance} in maintenance</span>
            </div>
            <Link to="/vehicles" className="text-blue-600 hover:underline text-xs block mt-1">View Vehicles →</Link>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="mt-2 text-sm">
              ...
              <span className="mx-1">•</span>
              <span className="text-red-600">{mockStats.clients.pendingPayments} pending payments</span>
            </div>
            <Link to="/clients" className="text-blue-600 hover:underline text-xs block mt-1">View Clients →</Link>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{mockStats.trips.completed + mockStats.trips.inProgress}</p>
              </div>
            ...
            <div className="mt-2 text-sm">
              <span className="text-blue-600 font-medium">{mockStats.trips.inProgress} in progress</span>
              <span className="mx-1">•</span>
              <span className="text-green-600">{mockStats.trips.scheduled} scheduled</span>
            </div>
            <Link to="/trips" className="text-blue-600 hover:underline text-xs block mt-1">View Trips →</Link>
          </CardContent>
        </Card>
      </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Link to="/fuel" className="text-blue-600 hover:underline text-sm">View All</Link>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Link to="/trips" className="text-blue-600 hover:underline text-sm">View All</Link>
            </div>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Link to="/maintenance" className="text-blue-600 hover:underline text-sm">View All</Link>
            </div>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-xl font-semibold text-yellow-600">{mockStats.maintenance.pendingRepairs}</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg col-span-2">
                <p className="text-sm text-gray-500">Total Maintenance Costs</p>
                <p className="text-xl font-semibold">{formatCurrency(mockStats.maintenance.totalCost)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="mt-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link to="/drivers/add" className="p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-200 flex flex-col items-center text-center">
            <User className="h-8 w-8 text-blue-600 mb-2" />
            <span className="font-medium">Add Driver</span>
          </Link>
          <Link to="/vehicles/add" className="p-4 border border-gray-200 rounded-lg hover:bg-green-50 hover:border-green-200 flex flex-col items-center text-center">
            <Truck className="h-8 w-8 text-green-600 mb-2" />
            <span className="font-medium">Add Vehicle</span>
          </Link>
          <Link to="/clients/add" className="p-4 border border-gray-200 rounded-lg hover:bg-purple-50 hover:border-purple-200 flex flex-col items-center text-center">
            <Building2 className="h-8 w-8 text-purple-600 mb-2" />
            <span className="font-medium">Add Client</span>
          </Link>
          <Link to="/trips/add" className="p-4 border border-gray-200 rounded-lg hover:bg-orange-50 hover:border-orange-200 flex flex-col items-center text-center">
