...
const FuelTheftDetection: React.FC = () => {
  ...
  const getStatusTag = (status: string) => {
    switch (status) {
      ...
      case 'investigating':
        return <Tag icon={<ExclamationCircleOutlined />} color="processing">Investigating</Tag>;
      case 'resolved':
        return <Tag icon={<CheckCircleOutlined />} color="success">Resolved</Tag>;
      case 'false_alarm':
        return <Tag icon={<CloseCircleOutlined />} color="warning">False Alarm</Tag>;
      default:
  ...
  const alertColumns = [
    ...
    },
    {
      ...
      onFilter: (value: string, record: AlertData) => record.alertType === value,
    },
    {
      title: 'Severity',
      dataIndex: 'severity',
      ...
      onFilter: (value: string, record: AlertData) => record.severity === value,
    },
    {
      title: 'Status',
      dataIndex: 'status',
    ...
    },
    {
      ...
      render: () => (
        <Space size="small">
          ...
          <Button type="link" icon={<UserOutlined />} size="small">Assign</Button>
        </Space>
      ),
    },
  ];
  ...
  const patternColumns = [
    ...
    },
    {
      ...
      onFilter: (value: string, record: TheftPattern) => record.status === value,
    },
    {
      title: 'Actions',
      key: 'actions',
    ...
    <div className="fuel-theft-detection-page">
      <Card>
        ...
        <Tabs activeKey={activeTab} onChange={setActiveTab}>
          <TabPane 
            tab={<span><Badge count={3} offset={[10, 0]}>Active Alerts</Badge></span>} 
            key="1"
          >
              ...
              expandable={{
                expandedRowRender: (record) => (
                  <div style={{ padding: '20px' }}>
                    <p><strong>Alert Details:</strong> {record.details}</p>
                    {record.assignedTo && <p><strong>Assigned To:</strong> {record.assignedTo}</p>}
          ...
          <TabPane 
            tab={<span>Detection Patterns</span>} 
            key="2"
          >
            <div style={{ marginBottom: '16px' }}>
              <Space>
          ...
          >
            ...
            <Button type="primary" disabled>Generate Report</Button>
          </TabPane>
        </Tabs>
      </Card>
    </div>
