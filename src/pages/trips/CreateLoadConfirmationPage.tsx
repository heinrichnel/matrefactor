      ...
      {success && (
        <div className="bg-green-50 border-l-4 border-green-500 p-4 mb-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-green-700">Load confirmation created successfully! Redirecting...</p>
            </div>
          </div>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <label htmlFor="confirmationNumber" className="block text-sm font-medium text-gray-700">Load Confirmation No</label>
              <input
                type="text"
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <label htmlFor="clientName" className="block text-sm font-medium text-gray-700">Client/Supplier Name</label>
              <input
                type="text"
                id="clientName"
                name="clientName"
            ...
            <div>
              <label htmlFor="clientCompany" className="block text-sm font-medium text-gray-700">Client/Supplier Company Name</label>
              <input
                type="text"
                id="clientCompany"
                name="clientCompany"
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="goodsDescription" className="block text-sm font-medium text-gray-700">Goods Description</label>
              <input
                type="text"
                id="goodsDescription"
            ...
            <div>
              <label htmlFor="weight" className="block text-sm font-medium text-gray-700">Weight (in Tons/Kg)</label>
              <input
                type="text"
                id="weight"
                name="weight"
            ...
            <div>
              <label htmlFor="temperatureControl" className="block text-sm font-medium text-gray-700">Temperature Control (if applicable)</label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="truckRequired" className="block text-sm font-medium text-gray-700">Truck Required</label>
              <input
                type="text"
                id="truckRequired"
                name="truckRequired"
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="additionalCosts" className="block text-sm font-medium text-gray-700">Additional Costs</label>
              <input
                type="text"
                id="additionalCosts"
            ...
            <div className="md:col-span-2">
              ...
              <div className="border border-gray-300 rounded-md p-4 bg-gray-50 text-sm">
                ...
                <ul className="list-disc pl-5 mb-2">
                  <li>Discounts on Rate Per Load: Discounts will be offered on certain agreed routes and based on the number of loads per month.</li>
                  <li>Special Rates: Special rates will apply when backloads are provided from the point of off-loading to the point of origin.</li>
                </ul>
                ...
                <ul className="list-disc pl-5 mb-2">
                  <li>Annual price escalation takes effect in the business commencement month, displayed on the tariff list</li>
                </ul>
                
                <p className="font-medium mb-2">Fuel Adjustments:</p>
                <ul className="list-disc pl-5 mb-2">
                  <li>Monthly fuel adjustments as per statutory notifications. Rates quoted will be adjusted on a monthly basis depending on fluctuation in fuel price.</li>
                </ul>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <label htmlFor="authorizedBy.name" className="block text-sm font-medium text-gray-700">Name</label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="authorizedBy.position" className="block text-sm font-medium text-gray-700">Position</label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="authorizedBy.date" className="block text-sm font-medium text-gray-700">Date</label>
              <input
                type="date"
        ...
        <div className="flex justify-end">
          <Button onClick={() => navigate('/trips')} type="button" className="mr-2 bg-gray-600 hover:bg-gray-700">
            Cancel
          </Button>
